...
__global__ void __launch_bounds__(1024)
    FusedTransposeSplitQuantKernelOld(const phi::bfloat16* __restrict__ X,
...
#define LAUNCH_KERNEL(POW_2_SCALES, VEC_SIZE)                                \
  FusedTransposeSplitQuantKernelOld<phi::float8_e4m3fn, POW_2_SCALES, VEC_SIZE> \
...
PD_BUILD_OP(fused_transpose_split_quant_old)
