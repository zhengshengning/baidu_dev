...
def benchmark_paddle_vs_torch_rms_norm_backward():
    ...
    # hidden_sizes = [768, 1024, 1536, 2304, 2048, 3072, 4096, 8192, 10240]
    batch_sizes = [200]
    hidden_sizes = [2048]
    seq_lens = [32]
    ...
    for hidden_size in hidden_sizes:
        for batch_size in batch_sizes:
            for seq_len in seq_lens:
                ...
                grad_output_np = np.random.randn(batch_size, seq_len, hidden_size).astype('float32')
                ...
                for dtype in dtypes:
                    ...
                    try:
                        ...
                        # for _ in range(500):
                        #     # Paddle预热
                        #     y_paddle = F.rms_norm(x_paddle, (hidden_size,), weight_paddle, eps=epsilon)
